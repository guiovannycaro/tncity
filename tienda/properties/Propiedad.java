 ...
 */
package com.tienda.properties;

import java.io.IOException;
import java.io.InputStream;
import java.io.Serializable;
import java.util.Properties;
import com.tienda.util.SerialClone;
...
public class Propiedad implements Serializable {
    ...
    private Propiedad() {
        try {
            InputStream in = this.getClass().getResourceAsStream("/com/tienda/properties/version.properties");
            propVersion.load(in);
            in.close();

            in = this.getClass().getResourceAsStream("/com/tienda/properties/param.properties");
            propGlobal.load(in);
            in.close();

            in = this.getClass().getResourceAsStream("/com/tienda/properties/errors-.properties");
