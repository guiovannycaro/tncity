 ...
 */
import com.tienda.facade.general.AbstractFacade;
import com.tienda.jpa.pojo.Configuracion;
import com.tienda.jpa.pojo.Usuario;
import com.tienda.util.Archivo;
import com.tienda.util.JaxbUtil;
import java.io.File;
...
public class ParamFacade extends AbstractFacade<Configuracion> {
    ...
    private static String configPath = Configuracion.class.getResource("/com/tienda/config/config.xml").getFile();
