...
import com.tncity.control.seguridad.LoginAdminControl;
...
public class FacesUtil {
  ...
  public Benefactor getCurrentBen() {
    ...
    public Benefactor getCurrentBenefactor() {
        return getLoginBenefactorControl().getUsLog();
    }
    ...
    public boolean isCurrentUserAdmin() {
     ...
     public String getInformexKeyUser() {
        return "key-" + getCurrentUser().getIdusuario();
    }
