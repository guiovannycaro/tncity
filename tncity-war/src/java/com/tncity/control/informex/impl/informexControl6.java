...
import com.tncity.informex.entity.informeFacade6;
...
@ManagedBean(name = "informexControl6")
@RequestScoped
@Named
public class informexControl6 extends AbstractControl<Reportes> {



  @EJB
   informeFacade6 facadeInforme;
    ...
    public void nuevoreporte(String idusuario) {
        ...
        facadeInforme.createreporte(obj, err);
    ...
    public void TotalReportes() {
        ...
        totalConsulta = facadeInforme.countTotalReportes();

    }

    public void RecuperaReportes() {

        lstreportes = facadeInforme.TodosReportes("idreporte", "ASC");
    }

    public void RecuperaReportesByID(String idreporte) {

        lstreportes = facadeInforme.TodosReportesById(idreporte, "idreporte", "ASC");
    }
    
    public void TotalEstadoRecaudoFechas(String desde,String hasta,String idbenefactor,String idpasarela){
     totalConsulta = facadeInforme.countTotalRecaudosFechas(desde, hasta, idbenefactor,idpasarela);
    }
    ...
    public void TotalInformesFechas(String desde, String hasta, String idbenefactor,String idpasarela) {
        ...
        lstrecaudos = facadeInforme.ListarInformeFechas(desde, hasta, idbenefactor, idpasarela,"estado", "DESC");
    }
     ...
     public void generarExcel(String desde,String hasta,String benefactor,String idpasarela) {
        ...
        lstrecaudos = facadeInforme.ListarRecaudosFechas(desde, hasta, benefactor,idpasarela, "estado", "DESC");

        try {
            facadeInforme.generarExcel(lstrecaudos);
        } catch (IOException ex) {
            Logger.getLogger(informexControl.class.getName()).log(Level.SEVERE, null, ex);
        }

        urleXEL = facesUtil.getProtocolHostPortPath() + "/documentos/recaTnPagosFechas.xls";
     ...
     public void recuperaExel() {
          ...
          urlPdf = facesUtil.getProtocolHostPortPath() + "/documentos/recafechastnpagos.pdf";
          System.out.println("url recaudos " + urleXEL);
     }
    ...
    public String generarPdf(String desde, String hasta, String benefactor,String idpasarela) {
        ...
        facadeInforme.generarPdf(lstrecaudos );
     ...
     public String descargarPdf() {
        String url = "";
        url = facadeInforme.rutadescargas();
        return url ;
