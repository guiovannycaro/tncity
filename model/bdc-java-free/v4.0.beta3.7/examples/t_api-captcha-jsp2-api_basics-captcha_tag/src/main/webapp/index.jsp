    ...
    <div class="column">
        <div class="column">
            <div class="note">
                ...
                <p>The JSP Captcha Tag code example shows the most basic source code required to protect a JavaServer Pages form with BotDetect CAPTCHA's custom tag and validate the user input.</p>
