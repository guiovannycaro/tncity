...
@XmlRootElement
public class NotificacionSmSXml implements Serializable{
    ...
    List<NotificacionVarSmSXml> var = new ArrayList<>();
    ...
    @XmlElement(name = "var")
    public List<NotificacionVarSmSXml> getVar() {
        return var;
    }

    public void setVar(List<NotificacionVarSmSXml> var) {
        this.var = var;
    }
