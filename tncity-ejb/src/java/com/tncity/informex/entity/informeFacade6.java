...
@Stateless
public class informeFacade6 extends AbstractFacade<Recaudos> {
    ...
    public void generarExcel(List<Recaudos> lstrecaudos) throws IOException {
        ...
        rutaArchivo = Propiedad.getCurrentInstance().getPathInformes() + "recaTnPagosFechas.xls";
    ...
    public String crearPDF(List<Recaudos> lstrecaudos) {
        ...
        String ruta = "";
        String rutasis = "";
        String archivo = "recafechastnpagos.pdf";

        System.out.println("ruta guardar archivo" + Propiedad.getCurrentInstance().getPathInformes() + archivo);

        String rutaArchivo = "";

        rutaArchivo = Propiedad.getCurrentInstance().getPathInformes() + "recafechastnpagos.pdf";
        System.out.println("ruta archivo " + rutaArchivo);
        File fichero = new File(rutaArchivo);
       if (!fichero.exists()) {
            System.out.println("OJO: ¡¡No existe el archivo !!");
    ...
    public List<Reportes> TodosReportesById(String idreporte, String idreporte0, String asc) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public List<Reportes> TodosReportes(String idreporte, String asc) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
